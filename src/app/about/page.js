			...
			<section className={styles.information}>
				<div className={styles.personal_info}>
					...
					<p>
						...
						creative, i enjoy being creative in what i do, be that with editing,
						making videos or taking photos. So join me on this adventure and we
						will create some dope things together!
					</p>
